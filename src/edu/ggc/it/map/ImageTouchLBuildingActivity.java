...
public class ImageTouchLBuildingActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ggc_l_building_map);
		ImageView view = (ImageView) findViewById(R.id.imageView_ggc_l_Building_map);
